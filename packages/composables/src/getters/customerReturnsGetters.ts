...
export const getProductName = (returnProduct: ReturnItem): string =>
  returnProduct?.order_item?.product_name ? returnProduct?.order_item?.product_name : '';

export const getProductSku = (returnProduct: ReturnItem): string =>
  returnProduct?.order_item?.product_sku ? returnProduct?.order_item?.product_sku : '';
...
export const getProductReturnReason = (returnProduct: ReturnItem): string =>
  returnProduct?.custom_attributes
...
export const getStatus = (customerReturn: Return): string =>
  customerReturn?.status ? customerReturn?.status.replace(/_/g, ' and ').toLowerCase() : '';
